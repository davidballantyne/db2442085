    ...
    do{
        ...
        switch(choice){
                case 1:{
                    int a, b, c, d;
                    //prompt user
                                        cout<<"Enter two numbers to find the larger and smaller number\n"
                ...
                case 4:{
                    float l1, l2, w1,w2,a1,a2;
                                 cout<<"Enter the length and width for your first rectangle, separated by a space\n";
                                 cin>>l1>>w1;
                                 cout<<"Enter the length and width for your second rectangle, separated by a space\n";
                                 cin>>l2>>w2;
                                 //process
                                 a1=l1*w1;
                                 a2=l2*w2;
                ...
                case 5:{
                    float weight, height, bmi;
                                 ...
                                 cout<<"Enter the your weight (in pounds) and height (in feet) separate with a space\n";
                                 cin>>weight>>height;
